...
// ApplyLeaveScreen Component with Calendar in Modal
...
// const [clusterDatePickerVisible, setClusterDatePickerVisible] = useState(false);
...
//           const data = response.data.data;
//           // console.log('================', data);
//           // Extract leaveName and _id from each leaveTypeId
...
//     const selectedDate = day.dateString; // e.g., '2025-07-30'
...
//       setSelectingStartDate(true); // Reset for next selection
//     } else {
//       // Reset if invalid end date (before start date)
//       setStartDate(selectedDate);
//       setEndDate(null);
//       setMarkedDates({
//         [selectedDate]: {
...
//   //     Alert.alert(
//   //       'Error',
//   //       'Please fill all fields and select a valid date range.',
//   //     );
//   //     return;
//   //   }
...
//   //           ? 'Half-Day'
//   //           : 'Cluster',
//   //       lastDay: duration === 'full' ? 'Full-Day' : 'Half-Day',
//   //       halfDaySession: null,
//   //       clusterDates: [],
//   //       approvedBy: '',
//   //       comments: '',
...
//   //       Alert.alert(
//   //         'Success',
//   //         'Leave application submitted successfully. 111111111111',
//   //       );
//   //       setModalVisible(false);
//   //     } else {
//   //       Alert.alert(
//   //         'Error',
//   //         response.data.message || 'Failed to submit leave application.',
//   //       );
//   //     }
//   //   } catch (error) {
...
//   // Specific check for Half-Day
//   if (duration === 'half' && !halfDaySession) {
//     Alert.alert('Error', 'Please select half-day session (Morning/Evening).');
//     return;
//   }

//   // Specific check for Full-Day or Cluster
...
//   return (
//     // <View style={styles.applyLeaveContainer}>
//     //   <Text style={styles.applyLeaveTitle}>Apply for Leave 1</Text>
...
//     //           theme={{
//     //             selectedDayBackgroundColor: '#4A2C2A',
//     //             todayTextColor: '#4A2C2A',
//     //             arrowColor: '#4A2C2A',
//     //             monthTextColor: '#333',
...
//     //     <Text style={styles.submitButtonText}>Submit Leave Request 1</Text>
//     //   </TouchableOpacity>
//     // </View>
//     <View style={styles.applyLeaveContainer}>
...
//       {/* Full-day and cluster: show both start and end */}
//       {duration !== 'half' && (
//         <>
//           <Text style={styles.label}>Start Date</Text>
//           <TouchableOpacity
...
//       {/* Half-day: only start date and session dropdown */}
//       {duration === 'half' && (
//         <>
